...
<div class="container-fluid bg-primary mb-5">
    ...
    <input type="submit" name="s1" value="filter">
</form>
...
if(isset($_GET["s1"])){
    ...
    $con= mysqli_connect("localhost" , "root", "root", "jajjiproject") or die("Ulanmadi");

    $sql= "SELECT * FROM blogs where name like '$filter' ";

    $result = mysqli_query($con, $sql) or die(mysqli_error($con)) ;

    while($row = mysqli_fetch_assoc($result)){
        
            echo  $row["name"] . "-" . $row["info"]. "-". $row["blog"]."<br>" ;      
    }
